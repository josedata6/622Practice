...
# if __name__ == '__main__':
#     main(x = int(input("Enter first number: ")), y = int(input("Enter second number: ")) )
...
#     parser.add_argument('x', type=int, nargs='?', default=5, help='First number (default: 5)')
#     parser.add_argument('y', type=int, nargs='?', default=7, help='Second number (default: 7)')
...
# # Tuple Example # 1
# # Creating a Tuple, list innuible after the definition the item cannot be changed
